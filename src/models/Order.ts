...
export interface IOrder extends Document {
    ...
    items: IOrderItem[];
    deliveryAgent?: mongoose.Types.ObjectId; // assigned delivery person
    scheduledSlot?: string; // for scheduled orders
    deliveredAt?: Date; // actual delivery time
    address: {
        // snapshot so it persists even if user deletes address
        label: string;
        name: string;
        phone: string;
        line1: string;
